...
-- Dumping data for table sexiauditor.modules: ~61 rows (approximately)
DELETE FROM `modules`;
...
INSERT INTO `modules` (`id`, `module`, `type`, `displayName`, `version`, `description`, `category_id`, `schedule`) VALUES
	...
	(8, 'clusterAdmissionControl', 'report', 'Admission Control', 1, 'Admission Control report.', 3, 'off'),
	...
	(15, 'clusterTPSSavings', 'report', 'TPS savings', 1, 'TPS savings Report.', 3, 'off'),
	...
	(64, 'mailAlert', 'action', 'Mail Alert', 0, 'Will send an email with all defective checks', 8, 'daily');
...
-- Dumping data for table sexiauditor.users: ~2 rows (approximately)
DELETE FROM `users`;
