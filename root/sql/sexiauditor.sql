...
(4, 'vcPermissionReport', 'report', 'Permission report', '1', 'Display permission listing with user/role combination.', 2),
(5, 'vcTerminateSession', 'action', 'Terminate session', '1', '[Action] Kill vCenter session older than (x)days.', 2),
(6, 'vcCertificatesReport', 'report', 'Certificate Report', '1', 'Display soon-to-be-expired certificates for all vCenter components (SSO, WebClient, ...).', 2),
...
(13, 'clusterMembersLUNPathCountMismatch', 'report', 'Members LUN Path count mismatch', '1', 'Members LUN Path count mismatch Report.', 3),
...
(18, 'hostLUNPathDead', 'report', 'LUN Path Dead', '1', 'LUN Path Dead report.', 4),
...
(21, 'hostSshShell', 'report', 'SSH/shell check', '1', 'SSH/shell check report.', 4),
...
(31, 'hostPowerManagementPolicy', 'report', 'PowerManagement Policy', '1', 'PowerManagement Policy report.', 4),
...
('vcPermissionReport', 'daily'),
('vcSessionAge', 'daily'),
('vcTerminateSession', 'daily'),
