...
(18, 'senderMail', 3, 'Sender email to be used for report export feature', 'user@domain.tld'),
(19, 'recipientMail', 3, 'Recipient email to be used for report export feature', 'user@domain.tld'),
