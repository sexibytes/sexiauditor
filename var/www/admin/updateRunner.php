	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		if ($_POST["submit"] != "upgrade-confirmed")
			echo '            <div class="alert alert-success" role="alert">
                ...
                Current version of SexiAuditor is: <strong>' . $SexiAuditorVersion . '</strong>
            </div>
	    <div class="alert alert-warning" role="warning">
			...
			After the upgrade process is succeeded, SexiAuditor services will be restarted.
		...
		switch ($_POST["submit"]) {
			case "upgrade-confirmed":
				...
				if ($errorInCommand) {
					...
					Some errors occured during update of your SexiAuditor appliance. This shouldn\'t happen, but don\'t worry, we are here to help you!<br />
					If you want, you can take a look above to the report that can point you to the right direction, or you can send it to us at check &lt;at&gt; sexiauditor.fr
					...
					<form class="form" action="" method="post">
							<p><a class="btn btn-danger" href="mailto:check@sexiauditor.fr?subject=Error during upgrade&body=Please Find attached update error log."><i class="glyphicon glyphicon-remove-sign"></i> Send Support Mail</a></p>
			</div>';
				} else {
					...
					<p>The update of your SexiAuditor appliance completed successfully, you are now using version ' . $SexiAuditorNewVersion . '!</p>
