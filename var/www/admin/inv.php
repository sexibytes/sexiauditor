...
?>
    <div style="width:98%; padding:10px;">
      <div>Show/Hide column:
        ...
        <button type="button" class="btn btn-danger btn-xs toggle-vis" style="outline: 5px auto;" name="12" data-column="12">VMPath</button>
        <button type="button" class="btn btn-danger btn-xs toggle-vis" style="outline: 5px auto;" name="13" data-column="13">MAC</button>
      </div>
      <hr />
    ...
    <script type="text/javascript">
      $(document).ready( function () {
        var table = $('#inventory').DataTable( {
          ...
          "columnDefs": [ { "targets": [ 4, 5, 6, 7, 8, 9, 10, 12, 13 ], "visible": false } ]
        } );
