...
if (!is_array($vm = $sexihelper->getVMInfos($_GET['vmid'])))
{
...
} # END if (!is_array($vm = $sexihelper->getVMInfos($_GET['vmid'])))
...
if (is_array($datastore = $sexihelper->getDatastoreInfos($vm["datastore"], $vm["vcenterID"])))
{
