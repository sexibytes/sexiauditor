...
if (empty($_GET['moref']) or empty($_GET['vcenter'])) {  exit('  <div class="alert alert-danger" role="alert"><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span><span class="sr-only">Error:</span> Missing mandatory values</div>'); }
...
if (!is_object($vm = $check->getVMInfos($_GET['moref'], $_GET['vcenter']))) {
...
<div class="row">
    <div class="col-sm-4 col-xs-6">
        <div class="tile-stats tile-red">
            ...
            <div class="num">
                <?php echo (string)$vm->numcpu; ?> vCPU
            </div>
    ...
    <div class="col-sm-4 col-xs-6">
        <div class="tile-stats tile-aqua">
            ...
            <div class="num">
                <?php echo (string)$vm->commited; ?> GB / <?php echo (string)$vm->provisionned; ?> GB
            </div>
            <h3>Total of storage used / provisionned</h3>
        </div>
    </div>
</div>
...
<?php
if (is_object($datastore = $check->getDatastoreInfos($vm->datastore, $vm->vcenter))) {
...
?>
          <tr><td class="table-title text-right">Datastore</td><td style="padding-left: 10px;"><?php echo (string)$vm->datastore.$additionalDatastoreInfos; ?></td></tr>
