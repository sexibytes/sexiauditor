  ...
  switch($_GET['c'])
  {
    ...
    case 'VCPERMISSIONREPORT':
      ...
      $columns = array(
        ...
        array( 'db' => 'permissions.principal', 'dt' => 1, 'field' => 'principal', 'formatter' => function( $d, $row ) { if ($row[4] == '1') { return "<i class=\"icon-groups-friends\"></i> $d"; } else { return "<i class=\"icon-user\"></i> $d"; } } ),
    ...
    case 'VMINVENTORY':
      ...
      $columns = array(
        ...
        array( 'db' => 'h.host_name', 'dt' => 4, 'field' => 'host_name', 'formatter' => function( $d, $row ) { return '<a href=\'showhost.php?hostid=' . $row[18] . '\' rel="modal">' . $d . '</a>'; } ),
